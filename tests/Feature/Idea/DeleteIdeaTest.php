...
class DeleteIdeaTest extends TestCase
{
    ...
    /** @test */
    public function test_delete_an_idea_works_when_user_has_authorization()
    {
    ...
    /** @test */
    public function test_delete_an_idea_with_votes_when_user_has_authorization()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function test_delete_an_idea_with_comments_when_user_has_authorization()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function test_delete_an_idea_works_when_user_is_admin()
    {
